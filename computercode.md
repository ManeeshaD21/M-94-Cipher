...
def main():
    ...
    for letter in message:
      ...
      # Find location of letter in alphabet
        ...
        #pass this letter through rotor1
        pos = translate(alpha, disk5, pos) #starting, ending, current position
        pos = translate(alpha, disk4, pos)
        pos = translate(alpha, disk3, pos)
        pos = translate(alpha, disk2, pos) #starting, ending, current position
        pos = translate(alpha, disk1, pos)
        ...
        if pos != 0 and pos % 26 == 0: disk3 = rotate(disk3)
        if pos != 0 and pos % 26 == 0: disk2 = rotate(disk2)
        if pos != 0 and pos % 26 == 0: disk1 = rotate(disk1)
